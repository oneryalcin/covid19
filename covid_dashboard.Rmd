...
one_week_ago = Sys.Date() - 9
two_weeks_ago = one_week_ago - 14
...
valueBox( paste("+ ",as.character(last7_days$total)), caption = paste("cases in last 7 days","(", last7_days$total - last7_14_days$total," from 2 weeks ago)"), color = "#05668d")
...
valueBox( paste("+", as.character(last7_days$total)), caption = paste("deaths in last 7 days","(", last7_days$total - last7_14_days$total," from 2 weeks ago)"), color = '#02c39a')
