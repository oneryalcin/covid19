...
valueBox( paste("+ ",as.character(last7_days$total)), caption = "cases in last 7 days", color = "#05668d")
...
valueBox( paste("+", as.character(last7_days$total)), caption = "deaths in last 7 days", color = '#02c39a')
